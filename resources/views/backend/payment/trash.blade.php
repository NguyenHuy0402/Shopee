                    ...
                    <tr>
                      ...
                      <td>{{ $row->amount }}</td>
                        <td class="text-center">
                            ...
                            <a href="{{ route('admin.payment.restore', $args ) }}" class="btn btn-sm btn-primary">
                                <i class="fas fa-undo"></i>
                            </a>
                            <form action="{{ route('admin.payment.destroy', $args ) }}" method="post" class="d-inline" >
                                @csrf
                                @method('delete')
